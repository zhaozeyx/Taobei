 ...
 */
public class DealRecordsActivity extends BasicTitleBarActivity {
  ...
  private void loadData() {
    manageRpcCall(mUserService.myBenefitList(new ProfitRecordsParams(getComponent()
  ...
  public boolean initializeTitleBar() {
    setMiddleTitle(R.string.activity_deal_records_title);
  ...
  class RecordListAdapter extends RecyclerView.Adapter<ChildViewHolder> {
    ...
    public ChildViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View view = LayoutInflater.from(DealRecordsActivity.this).inflate(R.layout
