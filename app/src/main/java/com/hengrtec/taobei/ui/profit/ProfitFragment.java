...
//   //        screenshot();
    // 获取内置SD卡路径
    createQRImage("http://img003.21cnimg" +
        ".com/photos/album/20160516/m600/70DEAFE38FD36B70646E9B369827F600.jpeg");
    ...
    ShareUtils.showShareWechatMoments(getActivity(), Environment.getExternalStorageDirectory()
        .getPath() + File.separator + "bb.png", null);
  }
  ...
  private void showShare() {
    ...
    sp.setImagePath(Environment.getExternalStorageDirectory().getPath() + File.separator + "bb" +
        ".png");
    sp.setSite("呵呵");
...
//        oks.setImagePath(Environment.getExternalStorageDirectory().getPath()+File.separator+"bb
// .png");//确保SDcard下面存在此张图片
//
//
//// 启动分享GUI
