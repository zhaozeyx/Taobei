 ...
 */
public class BBJGraphProfitDetailFragment extends BaseGraphProfitDetailFragment {

  public static BBJGraphProfitDetailFragment newInstance(MyBenefitModel model) {

    Bundle args = new Bundle();
    args.putParcelable(BUNDLE_KEY_MODEL, model);
    BBJGraphProfitDetailFragment fragment = new BBJGraphProfitDetailFragment();
  ...
  private void bindData() {
    ...
    mGraphTitleView.setText(R.string.activity_profit_detail_graph_title_bbj);
    ...
    for (int value : mModel.getYData2()) {
    ...
    for (int i = 0; i < mModel.getYData2().size(); i++) {
      yVals.add(new Entry(mModel.getYData2().get(i), i));
    }
