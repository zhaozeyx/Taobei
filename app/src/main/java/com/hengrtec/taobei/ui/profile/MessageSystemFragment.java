...
import com.hengrtec.taobei.net.rpc.model.GrabMyMessageModel.MessageBean;
 ...
 */
public class MessageSystemFragment extends BaseMessageListFragment {

  public static MessageSystemFragment newInstance(int type) {
  ...
  class MessageListAdapter extends BaseMessageAdapter<ItemViewHolder> {
    ...
    public ItemViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
      View view = LayoutInflater.from(getActivity()).inflate(R.layout
          .fragment_message_system_list_item, parent, false);
